package io.jans.agamapasskey.notify;
...
public class SGNotificationsUtil {
    ...
    private String getTargetEndpointArn(RegistrationPersistenceService rps, PushSnsService pss,
        ...
        try {
            ...
            String notificationConf = device.getDeviceNotificationConf();
            if (notificationConf != null) {
                JSONObject notificationJson = new JSONObject(notificationConf);
                targetEndpointArn = notificationJson.optString("sns_endpoint_arn", null);
            ...
            JSONObject conf = new JSONObject(Map.of("sns_endpoint_arn", targetEndpointArn));
            
            Fido2RegistrationEntry updatedDevice = rps.findRegisteredUserDevice(userInum, device.getId());
            updatedDevice.setDeviceNotificationConf(conf.toString());            
